...
import {ERC20BurnableWithSingleMinter, ERC721WithTokenboundERC20} from "../src/TokenboundERC20.sol";

contract MockERC721WithTokenboundERC20 is ERC721WithTokenboundERC20 {
    constructor(address tbaRegistryAddress, address tbaImplementationAddress) ERC721WithTokenboundERC20("test", "test", tbaRegistryAddress, tbaImplementationAddress, 0) {}
...
contract TokenboundERC20Tests is Test {
    ...
    MockERC721WithTokenboundERC20 private nfts;
    ...
    function setUp() public {
        ...
        nfts = new MockERC721WithTokenboundERC20(address(registry), address(accountImplementation));
    }
    ...
    function test_tberc20_mint_through_tba_as_nft_owner() public {
        uint256 tokenId = nfts.supply() + 1;
        nfts.mint(player1, tokenId);
        ERC20BurnableWithSingleMinter tberc20 = ERC20BurnableWithSingleMinter(nfts.tberc20(tokenId));
    ...
    function testRevert_tberc20_mint_directly_as_nft_owner() public {
        ...
        vm.prank(player1);
        vm.expectRevert(abi.encodeWithSelector(ERC20BurnableWithSingleMinter.InvalidMinter.selector, player1));
